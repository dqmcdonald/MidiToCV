...
public:
  ...
  inline bool getLast(byte& outPitch, byte& outVelocity) const;
  inline bool getHigh(byte& outPitch, byte& outVelocity) const;
  inline bool getLow(byte& outPitch, byte& outVelocity ) const;
 ...
 */
template<byte Size>
inline bool MidiNoteList<Size>::getLast(byte& outPitch, byte& outVel) const
{
  if (!mTail)
  {
    return false;
 ...
 */
template<byte Size>
inline bool MidiNoteList<Size>::getHigh(byte& outPitch, byte& outVelocity ) const
{
  if (!mTail)
  {
    return false;
 ...
 */
template<byte Size>
inline bool MidiNoteList<Size>::getLow(byte& outPitch, byte& outVelocity) const
{
  if (!mTail)
  {
    return false;
